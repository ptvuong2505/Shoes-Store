...
namespace Application.Interfaces
{
    public interface IAuthService
    {
        ...
        Task<VerifyOtpResultDto> VerifyOtpAsync(string email, string otp);
        Task ResetPasswordAsync(string email, string resetToken, string newPassword, string confirmPassword);
